...
function show404() {
  ...
  el.innerHTML = '<div class="ui grid"><div class="sixteen wide column"><div class="card shadow" style="text-align:center;padding:80px 30px;"><i class="ui icon frown" style="font-size:4rem;color:gray;"></i><h1 style="color:gray;margin-top:20px;">404 - 页面未找到</h1><p style="color:gray;">您访问的页面不存在</p><a href="/" class="ui primary button" style="margin-top:20px;"><i class="ui icon home"></i> 返回主页</a></div></div></div>';
}
